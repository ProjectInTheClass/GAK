...
class CameraViewController: UIViewController, AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureDepthDataOutputDelegate, AVCaptureDataOutputSynchronizerDelegate {
    ...
    private let filterRenderers: [FilterRenderer] = [RosyMetalRenderer(), RosyCIRenderer(), NewCIRenderer(), LayeredCIRenderer()]
    
    private let photoRenderers: [FilterRenderer] = [RosyMetalRenderer(), RosyCIRenderer(), NewCIRenderer(), LayeredCIRenderer()]
    ...
    @IBAction private func toggleFiltering() {
        ...
        // x ///Enable/disable the photo filter.
        processingQueue.async {
            if filteringEnabled {
